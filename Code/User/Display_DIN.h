...
// Fan Currents
#define SCREEN_FAN_1_DISPLAY            99
#define SCREEN_FAN_1_CURRENT           100
...
// Digital I/O
#define SCREEN_DIG_INPUT_DISPLAY       110
#define SCREEN_DIG_INPUT_VALUE         111
#define SCREEN_DIG_OUTPUT_DISPLAY      112
#define SCREEN_DIG_OUTPUT_VALUE        113
  ...
  const uint8_t SCREEN_SEQ_3P_MAIN[]=
  {
   ...
   SCREEN_FAN_1_DISPLAY,
   SCREEN_FAN_1_CURRENT,
   SCREEN_FAN_2_DISPLAY,
   SCREEN_FAN_2_CURRENT,
   SCREEN_AMBIENT_TEMPERATURE,
   SCREEN_DIG_INPUT_DISPLAY,
   SCREEN_DIG_INPUT_VALUE,
   SCREEN_DIG_OUTPUT_DISPLAY,
   SCREEN_DIG_OUTPUT_VALUE,
   0XFF,
  };
