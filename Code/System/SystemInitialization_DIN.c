...
{ 
  ...
  SWITCH_OFF_RELAY_R_PHASE_GRID_HEALTHY;
  SWITCH_OFF_RELAY_Y_PHASE_GRID_HEALTHY;
  SWITCH_OFF_RELAY_B_PHASE_GRID_HEALTHY;
  SWITCH_OFF_RELAY_LOAD_ON_SOLAR;
  SWITCH_OFF_RELAY_LOAD_ON_GRID;
}
